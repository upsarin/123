		<div class="page-image contacts"><img id="detail_banner" src="/css/images/content/courses/moscow/baner/pro-course_old.jpg"></div>
...
<div class="content-container-wrapper course-header">
                ...
                <div class="content">
                    <div class="row">
                        <div class="column col-md-12">
                            ...
                            <h2 class="block-header thin">PRO курс DJ Школы</h2>
                        ...
                        <div class="row">
                            <div class="row-container">
                                ...
                                <section class="course-feature left col-md-12">
                                    <h2 class="block-header">Курс состоит из 14 занятий по 2 часа</h2>
            ...
            <div class="content-container">
                <div class="content">
                    <div class="course-includes-container">
                        <h2 class="block-header">PRO курс включает в себя:</h2>
                        <div class="row">
                            <div class="course-includes-block col-md-12">
                                ...
                                <h3 class="block-header">Стоимость: 68 000 тг.</h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="page-image"><img src="/css/images/content/courses/almaty/baner/pro-course.jpg"></div>
            <div class="content-container">
                <div class="content">
                    <div class="row">
                    <div class="column col-md-12">
                            ...
                            <div class="sections-holder responsive">
                                ...
                                <section class="col-md-4 col-sm-4">
                                    <a href="/courses/detail/scratch-base/">
                                        <div class="image-container" style="height: 320px;"><img class="image" src="/css/images/content/courses/almaty/DJ/scratch.png"></div>
