		<div class="page-image contacts"><img id="detail_banner" src="/css/images/content/courses/moscow/baner/scratch-base_old.jpg"></div>
...
<div class="content-container-wrapper course-header">
                ...
                <div class="content">
                    <div class="action-container">
                        <div class="image-container" style="text-align:center">
                            <img class="course-image" src="/css/images/content/courses/almaty/DJ/scratch.png">
                        </div>
                        ...
                        <div class="row">
                            <div class="row-container">
                                ...
                                <section class="course-feature left col-md-12">
                                    <h2 class="block-header">Курс состоит из 10 занятий по 60 минут</h2>
                    ...
                    <div class="course-includes-container">
                        ...
                        <div class="row">
                            <div class="course-includes-block col-md-12">
                                ...
                                <h3 class="block-header">Стоимость: 35 000 тг.</h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="page-image"><img src="/css/images/content/courses/almaty/baner/scratch-base.jpg"></div>
            <div class="content-container">
                <div class="content">
                    <div class="row">
                    <div class="column col-md-12">
                            ...
                            <div class="sections-holder responsive">
                                ...
                                <section class="col-md-4 col-sm-4">
                                    <a href="/courses/detail/pro-course/">
                                        <div class="image-container" style="height: 320px;"><img class="image" src="/css/images/content/courses/almaty/DJ/pro.png"></div>
