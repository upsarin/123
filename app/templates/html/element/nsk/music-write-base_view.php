...
<div class="content-container-wrapper course-header">
                ...
                <div class="content">
                    <div class="row">
                        <div class="column col-md-12">
                            ...
                            <h2 class="block-header thin">Базовый курс Школы Написания Музыки</h2>
                    ...
                    <div class="course-includes-container">
                        ...
                        <div class="row">
                            <div class="course-includes-block col-md-12">
                                ...
                                <h3 class="block-header">Стоимость: 10 000 р.</h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="page-image"><img src="/css/images/content/courses/novosibirsk/baner/music-write-base.jpg"></div>
            <div class="content-container">
                <div class="content">
                    <div class="row">
                    <div class="column col-md-12">
                            ...
                            <div class="sections-holder responsive">
                                ...
                                <section class="col-md-4 col-sm-4">
                                    <a href="/courses/detail/music-write-base/">
                                        <div class="image-container" style="height: 320px;"><img class="image" src="/css/images/content/courses/novosibirsk/music/base.png"></div>
