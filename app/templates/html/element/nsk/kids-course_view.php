                                        ...
                                        <div class="input-box select-box col-md-8 col-sm-8">
                                            ...
                                            <div class="btn-group bootstrap-select form-control">
												<select class="selectpicker" id="course_form">
														<option value="kids-course" selected="selected">Kids курс DJ Школы</option>
...
<div class="content-container-wrapper course-header">
                ...
                <div class="content">
                    <div class="row">
                        <div class="column col-md-12">
                            ...
                            <h2 class="block-header thin">Kids курс DJ Школы</h2>
                ...
                <div class="content">
                    <div class="action-container">
                        <div class="image-container" style="text-align:center">
                            <img class="course-image" src="/css/images/content/courses/novosibirsk/DJ/kids.png">
                        </div>

                        <h2 class="block-header">Kids курс DJ Школы</h2>
                        <p class="description">Курс предназначен для детей и подростков от 8 до 14 лет, желающих научиться играть на DJ оборудовании. Начальные знания и навыки не обязательны.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="content-container">
                <div class="content">
                    <div class="course-includes-container">
                        <h2 class="block-header">KIDS курс включает в себя:</h2>
                        <div class="row">
        ...
        <div class="page-image"><img src="/css/images/content/courses/novosibirsk/baner/kids-course.jpg"></div>
            <div class="content-container">
                <div class="content">
                    <div class="row">
                    <div class="column col-md-12">
