		<div class="page-image contacts"><img id="detail_banner" src="/css/images/content/courses/moscow/baner/vinyl-course_old.jpg"></div>
                                        ...
                                        <div class="input-box select-box col-md-8 col-sm-8">
                                            ...
                                            <div class="btn-group bootstrap-select form-control">
												<select class="selectpicker" id="course_form">
														<option value="vinyl-course" selected="selected">Vinyl курс DJ Школы</option>
...
<div class="content-container-wrapper course-header">
                ...
                <div class="content">
                    <div class="row">
                        <div class="column col-md-12">
                            ...
                            <h2 class="block-header thin">Vinyl курс DJ Школы</h2>
                ...
                <div class="content">
                    <div class="action-container">
                        <div class="image-container" style="text-align:center">
                            <img class="course-image" src="/css/images/content/courses/novosibirsk/DJ/vinyl.png">
                        </div>

                        <h2 class="block-header">Vinyl курс DJ Школы</h2>
                        <p class="description">Курс предназначен для тех, кто уже умеет играть на цифровом оборудовании (CD, USB, Midi), но хочет научится сводить на виниловых проигрывателях.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="content-container">
                <div class="content">
                    <div class="course-includes-container">
                        <h2 class="block-header">Vinyl курс включает в себя:</h2>
                        <div class="row">
        ...
        <div class="page-image"><img src="/css/images/content/courses/novosibirsk/baner/vinyl-course.jpg"></div>
            <div class="content-container">
                <div class="content">
                    <div class="row">
                    <div class="column col-md-12">
