<div class="page-image contacts"><img id="detail_banner" src="/css/images/content/courses/moscow/baner/music-write-level-up.jpg"></div>
...
<div class="content-container-wrapper course-header">
                ...
                <div class="content">
                    <div class="row">
                        <div class="column col-md-12">
                            ...
                            <h2 class="block-header thin">Level UP курс Школы Написания Музыки</h2>
                ...
                <div class="content">
                    <div class="action-container">
                        <div class="image-container" style="text-align:center">
                            <img class="course-image" src="/css/images/content/courses/novosibirsk/music/levelup.png">
                        </div>

                        <h2 class="block-header">Level UP курс Школы Написания Музыки</h2>
                        <p class="description">Курс является конечным курсом для достижения максимальных навыков в обработке собственных треков. Структурируется только исходя из Ваших потребностей как по объёму знаний так и по количеству занятий</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="row-container">
                                ...
                                <section class="course-feature left col-md-12">
                                    ...
                                    <p>Оплата производится по занятиям (количество занятий не ограничено и определяется только вашими потребностями)</p>
                                </section>
            ...
            <div class="content-container">
                <div class="content">
                    <div class="course-includes-container">
                        <h2 class="block-header">Level UP курс включает в себя:</h2>
                        <div class="row">
                            <div class="course-includes-block col-md-12">
                                ...
                                <h3 class="block-header">Стоимость: 1 500 р.</h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="page-image"><img src="/css/images/content/courses/novosibirsk/baner/music-write-level-up.jpg"></div>
            <div class="content-container">
                <div class="content">
                    <div class="row">
                    <div class="column col-md-12">
