		<div class="page-image contacts"><img id="detail_banner" src="/css/images/content/courses/moscow/baner/midi-course_old.jpg"></div>
...
<div class="content-container-wrapper course-header">
                ...
                <div class="content">
                    <div class="row">
                        <div class="column col-md-12">
                            ...
                            <h2 class="block-header thin">MIDI курс DJ Школы</h2>
                ...
                <div class="content">
                    <div class="action-container">
                        <div class="image-container" style="text-align:center">
                            <img class="course-image" src="/css/images/content/courses/novosibirsk/DJ/midi.png">
                        </div>

                        <h2 class="block-header">MIDI курс DJ Школы</h2>
                        <p class="description">Курс предназначен для тех, кто уже знаком с игрой на классическом DJ комплекте микшер + CDJ,  но хочет научится играть на Midi-контроллерах и в совершенстве овладеть основными программами для диджеинга: rekordbox dj, Serato DJ и Traktor Pro 2</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="row-container">
                                ...
                                <section class="course-feature left col-md-12">
                                    <h2 class="block-header">Курс состоит из 7 занятий по 2 часа</h2>
            ...
            <div class="content-container">
                <div class="content">
                    <div class="course-includes-container">
                        <h2 class="block-header">MIDI курс включает в себя:</h2>
                        <div class="row">
        ...
        <div class="page-image"><img src="/css/images/content/courses/novosibirsk/baner/midi-course.jpg"></div>
            <div class="content-container">
                <div class="content">
                    <div class="row">
                    <div class="column col-md-12">
                            ...
                            <div class="sections-holder responsive">
                                ...
                                <section class="col-md-4 col-sm-4">
                                    <a href="/courses/detail/course-base/">
                                        <div class="image-container" style="height: 320px;"><img class="image" src="/css/images/content/courses/novosibirsk/DJ/base.png"></div>
