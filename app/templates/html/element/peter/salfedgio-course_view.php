		...
		<div class="page-image contacts"><img id="detail_banner" src="/css/images/content/courses/moscow/baner/solfedjio.jpg"></div>
                ...
                <div class="content">
                    <div class="row">
                        <div class="column col-md-12">
                            ...
                            <h2 class="block-header thin">Сольфеджио курс Школы Написания Музыки</h2>
                ...
                <div class="content">
                    <div class="action-container">
                        <div class="image-container" style="text-align:center">
                            <img class="course-image" src="/css/images/content/courses/peter/music/solfedjio.png">
                        </div>

                        <h2 class="block-header">Сольфеджио курс Школы Написания Музыки</h2>
                        <p class="description">Курс  для тех, кто хочет понять основы нотной грамоты , элементарной теории музыки и гармонии, развить слух.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="row-container">
                                ...
                                <section class="course-feature left col-md-12">
                                    ...
                                    <p>Средняя продолжительность курса - 2 месяца (по 2-4 занятия в неделю) /при желании можно заниматься чаще/</p>
                                </section>
            ...
            <div class="content-container">
                <div class="content">
                    <div class="course-includes-container">
                        <h2 class="block-header">Сольфеджио курс включает в себя:</h2>
                        <div class="row">
                            <div class="course-includes-block col-md-12">
                                
                                <ul>
                                    
                                    <li>Расширенное знания тональностей, ладов, ступеней, интервалов, аккордов</li>
                                    
                                    <li>Знание метрических размеров, ритмических рисунков</li>
                                    
                                    <li>Знание мелодических оборотов, строения музыкальной речи, приемов развития музыки.</li>
                                    
                                    <li>Знание музыкальных темпов и ритмов.</li>
                                    
                                </ul>
                                
                                <p class="additional-cons">По окончании школы выдаётся сертификат от компании Pioneer DJ</p>
                                
                                <h3 class="block-header">Стоимость: 45 000 р.</h3>
                            </div>
                        </div>
                    </div>
                </div>
