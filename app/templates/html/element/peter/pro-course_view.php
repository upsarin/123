                ...
                <div class="content">
                    <div class="action-container">
                        <div class="image-container" style="text-align:center">
                            <img class="course-image" src="/css/images/content/courses/peter/DJ/pro.png">
                        </div>
                    ...
                    <div class="course-includes-container">
                        ...
                        <div class="row">
                            <div class="course-includes-block col-md-12">
                                ...
                                <h3 class="block-header">Стоимость: 17 000р.</h3>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="sections-holder responsive">
                                ...
                                <section class="col-md-4 col-sm-4">
                                    <a href="/courses/detail/scratch-base/">
                                        <div class="image-container" style="height: 320px;"><img class="image" src="/css/images/content/courses/peter/DJ/scratch.png"></div>
