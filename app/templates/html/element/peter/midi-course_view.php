...
<div class="content-container-wrapper course-header">
                ...
                <div class="content">
                    <div class="action-container">
                        <div class="image-container" style="text-align:center">
                            <img class="course-image" src="/css/images/content/courses/peter/DJ/midi.png">
                        </div>
                    ...
                    <div class="course-includes-container">
                        ...
                        <div class="row">
                            <div class="course-includes-block col-md-12">
                                ...
                                <h3 class="block-header">Стоимость: 8 000 р.</h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="page-image"><img src="/css/images/content/courses/peter/baner/midi-course.jpg"></div>
            <div class="content-container">
                <div class="content">
                    <div class="row">
                    <div class="column col-md-12">
