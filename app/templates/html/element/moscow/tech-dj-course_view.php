		...
		<div class="page-image contacts"><img id="detail_banner" src="/css/images/content/courses/moscow/baner/tech-dj-course.jpg"></div>
...
<div class="content-container-wrapper course-header">
                ...
                <div class="content">
                    <div class="row">
                        <div class="column col-md-12">
                            ...
                            <h2 class="block-header thin">Техничный диджеинг курс DJ Школы</h2>
                ...
                <div class="content">
                    <div class="action-container">
                        <div class="image-container" style="text-align:center">
                            <img class="course-image" src="/css/images/content/courses/moscow/DJ/tech-dj-course.png">
                        </div>

                        <h2 class="block-header">Техничный диджеинг курс DJ Школы</h2>
                        <p class="description">Курс предназначен для тех, кто хочет научится интегрировать скретч и фастмиксинг в свои выступления и научиться техничной и креативной работе в своих выступлениях.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="row-container">
                                ...
                                <section class="course-feature left col-md-12">
                                    <h2 class="block-header">Курс состоит из 10 занятий по 2 часа</h2>
            ...
            <div class="content-container">
                <div class="content">
                    <div class="course-includes-container">
                        <h2 class="block-header">Курс техничного диджеинга включает в себя</h2>
                        <div class="row">
        ...
        <div class="page-image"><img src="/css/images/content/courses/moscow/baner/tech-dj-course.jpg"></div>
            <div class="content-container">
                <div class="content">
                    <div class="row">
                    <div class="column col-md-12">
