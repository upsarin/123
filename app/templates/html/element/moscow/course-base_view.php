		...
		<div class="page-image contacts"><img id="detail_banner" src="/css/images/content/courses/moscow/baner/djbase.jpg"></div>
                                        ...
                                        <div class="input-box select-box col-md-8 col-sm-8">
                                            ...
                                            <div class="btn-group bootstrap-select form-control">
												<select class="selectpicker" id="course_form">
														...
														<option value="tech-dj-course">Техничный диджеинг курс DJ Школы</option>
                ...
                <div class="content">
                    <div class="row">
                        <div class="column col-md-12">
                            ...
                            <h2 class="block-header thin">Базовый курс DJ Школы</h2>
                ...
                <div class="content">
                    <div class="action-container">
                        <div class="image-container" style="text-align:center">
                            <img class="course-image" src="/css/images/content/courses/moscow/DJ/course-base.png"/>
                        </div>

                        <h2 class="block-header">Базовый курс DJ Школы</h2>
                        <p class="description">Курс предназначен для тех, кто хочет стать диджеем и пока что не обладает навыками сведения на DJ оборудовании или имеющихся навыков недостаточно для начала выступлений в ночных заведениях.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="content-container">
                <div class="content">
                    <div class="course-features-container">
                        <h2 class="block-header">КЛЮЧЕВЫЕ ОСОБЕННОСТИ</h2>
                        <div class="row">
                            <div class="row-container">
                                ...
                                <section class="course-feature left col-md-12">
                                    <h2 class="block-header">Курс состоит из 15 занятий по 2 часа</h2>
                                ...
                                <section class="course-feature left col-md-12">
                                    <h2 class="block-header">Предоставляется свободная практика на оборудовании DJ Центра</h2>
                                ...
                                <div class="course-feature-image"><div class="image-container"><div class="image-wrapper"><img src="/css/images/cource_exampple_image.png"/></div></div></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-container">
                <div class="content">
                    <div class="course-includes-container">
                        <h2 class="block-header">Базовый курс включает в себя:</h2>
                        <div class="row">
        ...
        <div class="page-image"><img src="/css/images/content/courses/moscow/baner/djbase.jpg"/></div>
            <div class="content-container">
                <div class="content">
                    <div class="row">
                    <div class="column col-md-12">
                            ...
                            <div class="sections-holder responsive">
                                ...
                                <section class="col-md-4 col-sm-4">
                                    <a href="/courses/detail/pro-course/" >
                                        <div class="image-container"><img class="image" src="/css/images/content/courses/moscow/DJ/pro-course.png" ></div>
                                ...
                                <section class="col-md-4 col-sm-4">
                                    <a href="/courses/detail/scratch-base/" >
                                        <div class="image-container"><img class="image" src="/css/images/content/courses/moscow/DJ/scratch-base.png" ></div>

                                        <span class="short-description">
                                            <h4 class="name">Scratch DJ курс DJ Школы</h4>
                                            <span class="description">Курс предназначен как для тех кто только хочет освоить Scratch, так и для тех, кто желает поднять имеющиеся навыки до максимума</span>
                                        </span>
                                        <span class="button-more"><em></em></span>
                                    </a>
                                </section>
                                ...
                                <section class="col-md-4 col-sm-4">
                                    <a href="/courses/detail/music-write-base/" >
                                        <div class="image-container"><img class="image" src="/css/images/content/courses/moscow/DJ/music-write-base.png" ></div>
