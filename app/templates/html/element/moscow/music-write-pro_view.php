		...
		<div class="page-image contacts"><img id="detail_banner" src="/css/images/content/courses/moscow/baner/pro.jpg"></div>
...
<div class="content-container-wrapper course-header">
                ...
                <div class="content">
                    <div class="row">
                        <div class="column col-md-12">
                            ...
                            <h2 class="block-header thin">PRO курс Школы Написания Музыки</h2>
                ...
                <div class="content">
                    <div class="action-container">
                        <div class="image-container" style="text-align:center">
                            <img class="course-image" src="/css/images/content/courses/moscow/DJ/music-write-pro.png">
                        </div>

                        <h2 class="block-header">PRO курс Школы Написания Музыки</h2>
                        <p class="description">Курс предназначен для тех, кто уже имеет законченные треки, но не может добиться нужного звучания, накрутить нужный звук. Именно этот курс поможет доделать все ваши незаконченные треки, улучшить навыки написания музыки, освоить эквализацию и компрессию, заполнить все пробелы</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="page-image"><img src="/css/images/content/courses/moscow/baner/pro.jpg"></div>
            <div class="content-container">
                <div class="content">
                    <div class="row">
                    <div class="column col-md-12">
