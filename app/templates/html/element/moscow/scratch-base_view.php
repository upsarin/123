		...
		<div class="page-image contacts"><img id="detail_banner" src="/css/images/content/courses/moscow/baner/scratch-base.jpg"></div>
...
<div class="content-container-wrapper course-header">
                ...
                <div class="content">
                    <div class="row">
                        <div class="column col-md-12">
                            ...
                            <h2 class="block-header thin">Scratch DJ курс DJ Школы</h2>
                ...
                <div class="content">
                    <div class="action-container">
                        <div class="image-container" style="text-align:center">
                            <img class="course-image" src="/css/images/content/courses/moscow/DJ/scratch-base.png">
                        </div>

                        <h2 class="block-header">Scratch DJ курс DJ Школы</h2>
                        <p class="description">Курс предназначен как для тех кто только хочет освоить Scratch, так и для тех, кто желает поднять имеющиеся навыки до максимума</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="content-container">
                <div class="content">
                    <div class="course-includes-container">
                        <h2 class="block-header">Scratch DJ курс включает в себя:</h2>
                        <div class="row">
        ...
        <div class="page-image"><img src="/css/images/content/courses/moscow/baner/scratch-base.jpg"></div>
            <div class="content-container">
                <div class="content">
                    <div class="row">
                    <div class="column col-md-12">
                            ...
                            <div class="sections-holder responsive">
                                ...
                                <section class="col-md-4 col-sm-4">
                                    <a href="/courses/detail/pro-course/">
                                        <div class="image-container" style="height: 320px;"><img class="image" src="/css/images/content/courses/moscow/DJ/pro-course.png"></div>
